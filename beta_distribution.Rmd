---
title: "Notes on the Beta distribution"
...
$$
p(q | n, k) = \frac{p(k | n, q)\ p(q | n)}{p(k | n)} = \frac{{n \choose k} q^k (1-q)^{n-k}\ \frac{1}{L}}{\sum_u \left[ {n \choose k} u^k (1-u)^{n-k}\ \frac{1}{L} \right ]}
$$
...
$$
p(q | n, k) = \frac{q^k (1-q)^{n-k}}{\sum_u u^k (1-u)^{n-k}}
$$
